...
import cn.xww.o2o.util.wechat.WechatUtil;
 ...
 * appid注册时的，uri自己注册的
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx26fab3a90073d681&redirect_uri=http://121.41.227.160/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
...
public class WechatLoginController {
    ...
    public String doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(FRONTEND.equals(roleType)){
            return "frontend/index";//用户
        }else {
            return "shopadmin/shoplist";//店家
        }
