...
import cn.xww.o2o.dao.LocalAuthDao;
...
@Service
public class LocalAuthServiceImpl implements LocalAuthServices {
...
//		String dest = cn.xww.o2o.util.FileUtil.getPersonInfoImagePath();
